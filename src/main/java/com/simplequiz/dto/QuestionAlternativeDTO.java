...
public class QuestionAlternativeDTO {
    ...
    public QuestionAlternativeDTO(Long id, String alternative, Boolean itsCorrect, String reference) {
        this.id = id;
    ...
    public QuestionAlternativeDTO(Long id, String alternative, String reference, Boolean itsCorrect) {
        this.id = id;
        this.alternative = alternative;
        this.reference = reference;
        this.itsCorrect = itsCorrect;
